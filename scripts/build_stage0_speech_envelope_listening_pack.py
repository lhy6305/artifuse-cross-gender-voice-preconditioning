...
DEFAULT_OUTPUT_DIR = ROOT / "tmp" / "stage0_speech_envelope_listening_pack" / "v1"
...
def write_readme(path: Path, rows: list[dict[str, str]]) -> None:
    lines = [
        ...
        "  --summary-csv tmp/stage0_speech_envelope_listening_pack/v1/listening_pack_summary.csv `",
        "  --output-csv tmp/stage0_speech_envelope_listening_pack/v1/listening_review_queue.csv `",
        "  --summary-md tmp/stage0_speech_envelope_listening_pack/v1/listening_review_quant_summary.md",
        "```",
        "",
    ]
