...
$ruleConfig = Join-Path $repoRoot ("experiments\stage0_baseline\v1_full\speech_world_stft_delta_candidate_{0}.json" -f $PackVersion)
$packDir = Join-Path $repoRoot ("artifacts\listening_review\stage0_speech_world_stft_delta_listening_pack\{0}" -f $PackVersion)
