...
def main() -> None:
    ...
    for row in selected_rows:
        ...
        stem = build_output_stem(row, target_direction=target_direction, method_token="lrank")
    ...
    write_pack_readme(
        ...
        rows=summary_rows,
        pack_title="Stage0 Speech Low-Rank Envelope Listening Pack",
        purpose="learned low-rank envelope subspace probe",
        script_name="build_stage0_speech_low_rank_envelope_listening_pack.py",
