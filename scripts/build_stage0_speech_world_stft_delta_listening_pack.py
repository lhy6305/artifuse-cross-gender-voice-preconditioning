...
DEFAULT_OUTPUT_DIR = ROOT / "tmp" / "stage0_speech_world_stft_delta_listening_pack" / "v1"
...
def main() -> None:
    ...
    for row in selected_rows:
        ...
        stem = f"{dataset_slug}__{row['gender']}__{target_direction}__worldstft__{row['utt_id']}"
