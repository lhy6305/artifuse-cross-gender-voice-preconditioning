...
- commit_steps: `30`
- commit_bias: `0.00`
- commit_temperature: `0.50`
- lambda_commit_l2: `0.150`
- lambda_commit_time: `0.070`
- lambda_commit_mass: `0.010`
...
.\python.exe .\scripts\run_encodec_atrr_code_commit_probe.py `
  ...
  --output-dir artifacts/diagnostics/encodec_atrr_code_commit_probe/smoke2_bias0_init05_temp05 `
  --bandwidth 24.0 `
  --delta-scale 0.20 `
  --delta-cap-db 1.50 `
  --quantizer-start 24 `
